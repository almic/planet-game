...
4. Collect input via interfaces, move, jump, etc.
    - Movement is a Vector3, to support flying/ crawling things
    - Need stable move as a boolean switch, redirect movement along angled floor. Necessary for players, sometimes needed for AI
    - Jump timers, jump should impulse forward slightly when moving
    - Crouch option
    - Walk option
    - Acceleration and stopping rate
    - Top ground speed
    - Slower on upward slopes, faster on downward slopes
    - Max slope angle
