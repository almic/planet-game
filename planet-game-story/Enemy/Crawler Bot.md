...
- [ ] Add bool to CrawlerCharacter to disable physical system and use IK only, so that testing can compare the two for accuracy. Ideally the physical system should only add reaction forces to legs and not have much affect on movement ability.
